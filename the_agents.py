...
query_agent = Agent(
	name="Query Agent",
	model=HAIKU,
	instructions=hydrated_markdown_section_contents(PROMPT_DIR / "query_agent.md",
													heading_name="System"),
...
article_pruner_agent = Agent(
	...
	model=HAIKU,
	instructions=hydrated_markdown_section_contents(PROMPT_DIR / "article_pruner_agent.md",
													heading_name="System"),
...
final_synthesizer_agent = Agent(
	...
	model=SONNET,
	instructions=hydrated_markdown_section_contents(PROMPT_DIR / "final_synthesizer_agent.md",
													heading_name="System"),
